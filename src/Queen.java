...
В Codeboard сдайте 3 класса: Queen, King и ChessPiece, класс ChessBoard не трогайте.
*/
public class Queen extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        return isInBounds(line, column, toLine, toColumn) &&
                ...
                isDiagonalOrVerticalOrHorizontalMove(line, column, toLine, toColumn) &&
    ...
    private boolean isDiagonalOrVerticalOrHorizontalMove(int line, int column, int toLine, int toColumn) {
        return Math.abs(toLine - line) == Math.abs(toColumn - column) && line == toLine || column == toColumn;
    }
